...
class cegeka_rabbitmq::config::definitions($rabbitmq_exchange = 'default_exchange', $rabbitmq_queue = 'default_queue', $rabbitmq_remote_user = 'remote', $rabbitmq_remote_passwordhash = 'R5KfDH3Qk64C+8S5doDgp/R7E2w=') {
  ...
  file {'rabbitmq_definitions':
    ...
    notify  => Class['cegeka_rabbitmq::service'],
